...
from .paper_pid_fig3 import _certificate, load_definition
...
def load_paper_pid_lan_profile(path: str | Path) -> PaperPidLanProfile:
    ...
    _fields(profile, {"schema_version", "scenario", "sample_count", "numeric", "range",
                      "plot", "output_root", "frozen_definition"})
    ...
    if raw_evidence is None:
        ...
        evidence = PrimeModulusEvidence(
            ...
            raw_evidence["certificate_sha256"], _certificate(raw_evidence["certificate"]),
        )
    ...
    return PaperPidLanProfile(
        ...
        definition_digest, definition_path,
