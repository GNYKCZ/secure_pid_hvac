...
> **#70 当前状态补记（2026-09-24）：**本页下方的“当前 main 事实”表保持 #65 当时的
> 历史快照。#69/#81 已合入 paper-inspired PID 明文基线；#70 新增
> [四精度安全对照及已保存证据](paper_pid_fig3.md)。所选 plant 状态坐标和 ZOH 是本仓库选择，
> 作者原矩阵与逐点 Fig. 3 数据仍缺失，故声明等级没有提升为“论文原数值复现”。
